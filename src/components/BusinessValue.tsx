...
const BusinessValue = () => {
  const values = [
    { icon: <TrendingUp size={24} />, title: 'Reduced operational costs', desc: 'Efficiency-first design philosophy.' },
    { icon: <Maximize size={24} />, title: 'Optimized space utilization', desc: 'Maximizing every square foot.' },
    { icon: <ShieldCheck size={24} />, title: 'Future-ready infrastructure', desc: 'Adaptable to evolving needs.' },
    { icon: <BarChart3 size={24} />, title: 'High asset appreciation', desc: 'Quality that drives value.' },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-end mb-24">
          <div className="max-w-2xl">
            <h2 className="text-gold text-xs uppercase tracking-[0.3em] mb-6">Investment</h2>
            <h3 className="text-5xl md:text-7xl font-serif leading-tight">
              Business Value <br /> Delivered
            </h3>
          </div>
          <p className="text-linen/60 max-w-sm font-light mt-8 lg:mt-0 italic">
            "Every structure is an investment multiplier."
          </p>
        </div>
